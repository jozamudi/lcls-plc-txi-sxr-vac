...
# Project version: e3f1aeb
#    Project hash: e3f1aeb8bea7f877738f73a822480e88dfb98b40
...
epicsEnvSet("IPADDR",           "172.21.136.29")
epicsEnvSet("AMSID",            "172.21.136.29.1.1")
epicsEnvSet("AMS_PORT",         "851")
epicsEnvSet("ADS_MAX_PARAMS",   "2881")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:TXI:SXR:VAC,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:TXI:SXR:VAC")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:TXI:SXR:VAC,PROJECT=plc-txi-sxr-vac.tsproj,HASH=e3f1aeb,VERSION=e3f1aeb,PYTMC=2.14.1,PLC_HOST=172.21.136.29")

#   LCLS General: * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=LCLS_General,VERSION=*,VENDOR=SLAC")
#   LCLS Vacuum: * (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=LCLS_Vacuum,VERSION=*,VENDOR=SLAC - LCLS")
#   PMPS: * (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=PMPS,VERSION=*,VENDOR=SLAC - LCLS")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_TcpIp: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=Tc2_TcpIp,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:TXI:SXR:VAC,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("txi_sxr_vac.db", "PORT=$(ASYN_PORT),PREFIX=PLC:TXI:SXR:VAC:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 1881
callbackSetQueueSize(5762)
